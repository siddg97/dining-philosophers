/*
dining philosophers problem with Resource Hierarchy Solution

****** IMPORTANT ***
THIS ACTUALLY MIGHT NOT WORK PROPERLY!!
ONLY USE IT FOR DATA STRUCTURE REFERENCE!!!
Also the printing out from 1-5, instead of 0-4 is annoying
...
/**
  ...
  Compile on UNIX system: gcc -o diningPhilosophers -std=c99 diningPhilosophers.c -lpthread
**/
