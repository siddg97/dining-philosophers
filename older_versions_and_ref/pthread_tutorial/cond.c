/*
Condition variables with 
pthread_cond_t() example

SOURCE:
https://gist.github.com/rtv/4989304

Q: Why does pthread_cond_wait() takes both *cond and pthread_mutex_t *mutex?
...
After the signal() pthread_cond_wait() gets the lock. And does what it needs to do. We still need to unlock mutex after main is done.
*/
